import{c as Un,o as Vn,C as o,s as Wn,a as $n,b as Te,d as ce,e as he,D as Yn,f as Le,g as jn}from"./cesium-BsaaIHww.js";import{_ as Kn,r as Xn,T as Qn,F as Zn,M as qn,o as Jn,m as et,f as nt,h as tt,i as it,H as ot}from"./index-IeycYJqZ.js";import"./index-DHQa5Yyz.js";const at=`<template>
  <demo-box :codeBlocks>
...
</div>`,wt=function(e,n){var t=e[n];return m.isArray(arguments[2])||m.isObject(arguments[2])?new ct(e,n,arguments[2]):m.isNumber(t)?m.isNumber(arguments[2])&&m.isNumber(arguments[3])?m.isNumber(arguments[4])?new ge(e,n,arguments[2],arguments[3],arguments[4]):new ge(e,n,arguments[2],arguments[3]):m.isNumber(arguments[4])?new me(e,n,{min:arguments[2],max:arguments[3],step:arguments[4]}):new me(e,n,{min:arguments[2],max:arguments[3]}):m.isString(t)?new ht(e,n):m.isFunction(t)?new $e(e,n,""):m.isBoolean(t)?new Ve(e,n):null};function yt(i){setTimeout(i,1e3/60)}var vt=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||yt,bt=(function(){function i(){L(this,i),this.backgroundElement=document.createElement("div"),m.extend(this.backgroundElement.style,{backgroundColor:"rgba(0,0,0,0.8)",top:0,left:0,display:"none",zIndex:"1000",opacity:0,WebkitTransition:"opacity 0.2s linear",transition:"opacity 0.2s linear"}),l.makeFullscreen(this.backgroundElement),this.backgroundElement.style.position="fixed",this.domElement=document.createElement("div"),m.extend(this.domElement.style,{position:"fixed",display:"none",zIndex:"1001",opacity:0,WebkitTransition:"-webkit-transform 0.2s ease-out, opacity 0.2s linear",transition:"transform 0.2s ease-out, opacity 0.2s linear"}),document.body.appendChild(this.backgroundElement),document.body.appendChild(this.domElement);var e=this;l.bind(this.backgroundElement,"click",function(){e.hide()})}return I(i,[{key:"show",value:function(){var n=this;this.backgroundElement.style.display="block",this.domElement.style.display="block",this.domElement.style.opacity=0,this.domElement.style.webkitTransform="scale(1.1)",this.layout(),m.defer(function(){n.backgroundElement.style.opacity=1,n.domElement.style.opacity=1,n.domElement.style.webkitTransform="scale(1)"})}},{key:"hide",value:function(){var n=this,t=function a(){n.domElement.style.display="none",n.backgroundElement.style.display="none",l.unbind(n.domElement,"webkitTransitionEnd",a),l.unbind(n.domElement,"transitionend",a),l.unbind(n.domElement,"oTransitionEnd",a)};l.bind(this.domElement,"webkitTransitionEnd",t),l.bind(this.domElement,"transitionend",t),l.bind(this.domElement,"oTransitionEnd",t),this.backgroundElement.style.opacity=0,this.domElement.style.opacity=0,this.domElement.style.webkitTransform="scale(1.1)"}},{key:"layout",value:function(){this.domElement.style.left=window.innerWidth/2-l.getWidth(this.domElement)/2+"px",this.domElement.style.top=window.innerHeight/2-l.getHeight(this.domElement)/2+"px"}}]),i})(),xt=st(`.dg ul{list-style:none;margin:0;padding:0;width:100%;clear:both}.dg.ac{position:fixed;top:0;left:0;right:0;height:0;z-index:0}.dg:not(.ac) .main{overflow:hidden}.dg.main{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear}.dg.main.taller-than-window{overflow-y:auto}.dg.main.taller-than-window .close-button{opacity:1;margin-top:-1px;border-top:1px solid #2c2c2c}.dg.main ul.closed .close-button{opacity:1 !important}.dg.main:hover .close-button,.dg.main .close-button.drag{opacity:1}.dg.main .close-button{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear;border:0;line-height:19px;height:20px;cursor:pointer;text-align:center;background-color:#000}.dg.main .close-button.close-top{position:relative}.dg.main .close-button.close-bottom{position:absolute}.dg.main .close-button:hover{background-color:#111}.dg.a{float:right;margin-right:15px;overflow-y:visible}.dg.a.has-save>ul.close-top{margin-top:0}.dg.a.has-save>ul.close-bottom{margin-top:27px}.dg.a.has-save>ul.closed{margin-top:0}.dg.a .save-row{top:0;z-index:1002}.dg.a .save-row.close-top{position:relative}.dg.a .save-row.close-bottom{position:fixed}.dg li{-webkit-transition:height .1s ease-out;-o-transition:height .1s ease-out;-moz-transition:height .1s ease-out;transition:height .1s ease-out;-webkit-transition:overflow .1s linear;-o-transition:overflow .1s linear;-moz-transition:overflow .1s linear;transition:overflow .1s linear}.dg li:not(.folder){cursor:auto;height:27px;line-height:27px;padding:0 4px 0 5px}.dg li.folder{padding:0;border-left:4px solid rgba(0,0,0,0)}.dg li.title{cursor:pointer;margin-left:-4px}.dg .closed li:not(.title),.dg .closed ul li,.dg .closed ul li>*{height:0;overflow:hidden;border:0}.dg .cr{clear:both;padding-left:3px;height:27px;overflow:hidden}.dg .property-name{cursor:default;float:left;clear:left;width:40%;overflow:hidden;text-overflow:ellipsis}.dg .cr.function .property-name{width:100%}.dg .c{float:left;width:60%;position:relative}.dg .c input[type=text]{border:0;margin-top:4px;padding:3px;width:100%;float:right}.dg .has-slider input[type=text]{width:30%;margin-left:0}.dg .slider{float:left;width:66%;margin-left:-5px;margin-right:0;height:19px;margin-top:4px}.dg .slider-fg{height:100%}.dg .c input[type=checkbox]{margin-top:7px}.dg .c select{margin-top:5px}.dg .cr.function,.dg .cr.function .property-name,.dg .cr.function *,.dg .cr.boolean,.dg .cr.boolean *{cursor:pointer}.dg .cr.color{overflow:visible}.dg .selector{display:none;position:absolute;margin-left:-9px;margin-top:23px;z-index:10}.dg .c:hover .selector,.dg .selector.drag{display:block}.dg li.save-row{padding:0}.dg li.save-row .button{display:inline-block;padding:0px 6px}.dg.dialogue{background-color:#222;width:460px;padding:15px;font-size:13px;line-height:15px}#dg-new-constructor{padding:10px;color:#222;font-family:Monaco, monospace;font-size:10px;border:0;resize:none;box-shadow:inset 1px 1px 1px #888;word-wrap:break-word;margin:12px 0;display:block;width:440px;overflow-y:scroll;height:100px;position:relative}#dg-local-explain{display:none;font-size:11px;line-height:17px;border-radius:3px;background-color:#333;padding:8px;margin-top:10px}#dg-local-explain code{font-size:10px}#dat-gui-save-locally{display:none}.dg{color:#eee;font:11px 'Lucida Grande', sans-serif;text-shadow:0 -1px 0 #111}.dg.main::-webkit-scrollbar{width:5px;background:#1a1a1a}.dg.main::-webkit-scrollbar-corner{height:0;display:none}.dg.main::-webkit-scrollbar-thumb{border-radius:5px;background:#676767}.dg li:not(.folder){background:#1a1a1a;border-bottom:1px solid #2c2c2c}.dg li.save-row{line-height:25px;background:#dad5cb;border:0}.dg li.save-row select{margin-left:5px;width:108px}.dg li.save-row .button{margin-left:5px;margin-top:1px;border-radius:2px;font-size:9px;line-height:7px;padding:4px 4px 5px 4px;background:#c5bdad;color:#fff;text-shadow:0 1px 0 #b0a58f;box-shadow:0 -1px 0 #b0a58f;cursor:pointer}.dg li.save-row .button.gears{background:#c5bdad url(data:image/png;base64,) 2px 1px no-repeat;height:7px;width:8px}.dg li.save-row .button:hover{background-color:#bab19e;box-shadow:0 -1px 0 #b0a58f}.dg li.folder{border-bottom:0}.dg li.title{padding-left:16px;background:#000 url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlI+hKgFxoCgAOw==) 6px 10px no-repeat;cursor:pointer;border-bottom:1px solid rgba(255,255,255,0.2)}.dg .closed li.title{background-image:url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlGIWqMCbWAEAOw==)}.dg .cr.boolean{border-left:3px solid #806787}.dg .cr.color{border-left:3px solid}.dg .cr.function{border-left:3px solid #e61d5f}.dg .cr.number{border-left:3px solid #2FA1D6}.dg .cr.number input[type=text]{color:#2FA1D6}.dg .cr.string{border-left:3px solid #1ed36f}.dg .cr.string input[type=text]{color:#1ed36f}.dg .cr.function:hover,.dg .cr.boolean:hover{background:#111}.dg .c input[type=text]{background:#303030;outline:none}.dg .c input[type=text]:hover{background:#3c3c3c}.dg .c input[type=text]:focus{background:#494949;color:#fff}.dg .c .slider{background:#303030;cursor:ew-resize}.dg .c .slider-fg{background:#2FA1D6;max-width:100%}.dg .c .slider:hover{background:#3c3c3c}.dg .c .slider:hover .slider-fg{background:#44abda}
`);Ct.inject(xt);var ke="dg",Fe=72,ze=20,ie="Default",J=(function(){try{return!!window.localStorage}catch{return!1}})(),ee=void 0,He=!0,$=void 0,fe=!1,Ye=[],_=function i(e){var n=this,t=e||{};this.domElement=document.createElement("div"),this.__ul=document.createElement("ul"),this.domElement.appendChild(this.__ul),l.addClass(this.domElement,ke),this.__folders={},this.__controllers=[],this.__rememberedObjects=[],this.__rememberedObjectIndecesToControllers=[],this.__listening=[],t=m.defaults(t,{closeOnTop:!1,autoPlace:!0,width:i.DEFAULT_WIDTH}),t=m.defaults(t,{resizable:t.autoPlace,hideable:t.autoPlace}),m.isUndefined(t.load)?t.load={preset:ie}:t.preset&&(t.load.preset=t.preset),m.isUndefined(t.parent)&&t.hideable&&Ye.push(this),t.resizable=m.isUndefined(t.parent)&&t.resizable,t.autoPlace&&m.isUndefined(t.scrollable)&&(t.scrollable=!0);var a=J&&localStorage.getItem(Y(this,"isLocal"))==="true",r=void 0,c=void 0;if(Object.defineProperties(this,{parent:{get:function(){return t.parent}},scrollable:{get:function(){return t.scrollable}},autoPlace:{get:function(){return t.autoPlace}},closeOnTop:{get:function(){return t.closeOnTop}},preset:{get:function(){return n.parent?n.getRoot().preset:t.load.preset},set:function(h){n.parent?n.getRoot().preset=h:t.load.preset=h,Pt(this),n.revert()}},width:{get:function(){return t.width},set:function(h){t.width=h,ye(n,h)}},name:{get:function(){return t.name},set:function(h){t.name=h,c&&(c.innerHTML=t.name)}},closed:{get:function(){return t.closed},set:function(h){t.closed=h,t.closed?l.addClass(n.__ul,i.CLASS_CLOSED):l.removeClass(n.__ul,i.CLASS_CLOSED),this.onResize(),n.__closeButton&&(n.__closeButton.innerHTML=h?i.TEXT_OPEN:i.TEXT_CLOSED)}},load:{get:function(){return t.load}},useLocalStorage:{get:function(){return a},set:function(h){J&&(a=h,h?l.bind(window,"unload",r):l.unbind(window,"unload",r),localStorage.setItem(Y(n,"isLocal"),h))}}}),m.isUndefined(t.parent)){if(this.closed=t.closed||!1,l.addClass(this.domElement,i.CLASS_MAIN),l.makeSelectable(this.domElement,!1),J&&a){n.useLocalStorage=!0;var f=localStorage.getItem(Y(this,"gui"));f&&(t.load=JSON.parse(f))}this.__closeButton=document.createElement("div"),this.__closeButton.innerHTML=i.TEXT_CLOSED,l.addClass(this.__closeButton,i.CLASS_CLOSE_BUTTON),t.closeOnTop?(l.addClass(this.__closeButton,i.CLASS_CLOSE_TOP),this.domElement.insertBefore(this.__closeButton,this.domElement.childNodes[0])):(l.addClass(this.__closeButton,i.CLASS_CLOSE_BOTTOM),this.domElement.appendChild(this.__closeButton)),l.bind(this.__closeButton,"click",function(){n.closed=!n.closed})}else{t.closed===void 0&&(t.closed=!0);var p=document.createTextNode(t.name);l.addClass(p,"controller-name"),c=xe(n,p);var u=function(h){return h.preventDefault(),n.closed=!n.closed,!1};l.addClass(this.__ul,i.CLASS_CLOSED),l.addClass(c,"title"),l.bind(c,"click",u),t.closed||(this.closed=!1)}t.autoPlace&&(m.isUndefined(t.parent)&&(He&&($=document.createElement("div"),l.addClass($,ke),l.addClass($,i.CLASS_AUTO_PLACE_CONTAINER),document.body.appendChild($),He=!1),$.appendChild(this.domElement),l.addClass(this.domElement,i.CLASS_AUTO_PLACE)),this.parent||ye(n,t.width)),this.__resizeHandler=function(){n.onResizeDebounced()},l.bind(window,"resize",this.__resizeHandler),l.bind(this.__ul,"webkitTransitionEnd",this.__resizeHandler),l.bind(this.__ul,"transitionend",this.__resizeHandler),l.bind(this.__ul,"oTransitionEnd",this.__resizeHandler),this.onResize(),t.resizable&&At(this),r=function(){J&&localStorage.getItem(Y(n,"isLocal"))==="true"&&localStorage.setItem(Y(n,"gui"),JSON.stringify(n.getSaveObject()))},this.saveToLocalStorageIfPossible=r;function C(){var d=n.getRoot();d.width+=1,m.defer(function(){d.width-=1})}t.parent||C()};_.toggleHide=function(){fe=!fe,m.each(Ye,function(i){i.domElement.style.display=fe?"none":""})};_.CLASS_AUTO_PLACE="a";_.CLASS_AUTO_PLACE_CONTAINER="ac";_.CLASS_MAIN="main";_.CLASS_CONTROLLER_ROW="cr";_.CLASS_TOO_TALL="taller-than-window";_.CLASS_CLOSED="closed";_.CLASS_CLOSE_BUTTON="close-button";_.CLASS_CLOSE_TOP="close-top";_.CLASS_CLOSE_BOTTOM="close-bottom";_.CLASS_DRAG="drag";_.DEFAULT_WIDTH=245;_.TEXT_CLOSED="Close Controls";_.TEXT_OPEN="Open Controls";_._keydownHandler=function(i){document.activeElement.type!=="text"&&(i.which===Fe||i.keyCode===Fe)&&_.toggleHide()};l.bind(window,"keydown",_._keydownHandler,!1);m.extend(_.prototype,{add:function(e,n){return ne(this,e,n,{factoryArgs:Array.prototype.slice.call(arguments,2)})},addColor:function(e,n){return ne(this,e,n,{color:!0})},remove:function(e){this.__ul.removeChild(e.__li),this.__controllers.splice(this.__controllers.indexOf(e),1);var n=this;m.defer(function(){n.onResize()})},destroy:function(){if(this.parent)throw new Error("Only the root GUI should be removed with .destroy(). For subfolders, use gui.removeFolder(folder) instead.");this.autoPlace&&$.removeChild(this.domElement);var e=this;m.each(this.__folders,function(n){e.removeFolder(n)}),l.unbind(window,"keydown",_._keydownHandler,!1),Ge(this)},addFolder:function(e){if(this.__folders[e]!==void 0)throw new Error('You already have a folder in this GUI by the name "'+e+'"');var n={name:e,parent:this};n.autoPlace=this.autoPlace,this.load&&this.load.folders&&this.load.folders[e]&&(n.closed=this.load.folders[e].closed,n.load=this.load.folders[e]);var t=new _(n);this.__folders[e]=t;var a=xe(this,t.domElement);return l.addClass(a,"folder"),t},removeFolder:function(e){this.__ul.removeChild(e.domElement.parentElement),delete this.__folders[e.name],this.load&&this.load.folders&&this.load.folders[e.name]&&delete this.load.folders[e.name],Ge(e);var n=this;m.each(e.__folders,function(t){e.removeFolder(t)}),m.defer(function(){n.onResize()})},open:function(){this.closed=!1},close:function(){this.closed=!0},hide:function(){this.domElement.style.display="none"},show:function(){this.domElement.style.display=""},onResize:function(){var e=this.getRoot();if(e.scrollable){var n=l.getOffset(e.__ul).top,t=0;m.each(e.__ul.childNodes,function(a){e.autoPlace&&a===e.__save_row||(t+=l.getHeight(a))}),window.innerHeight-n-ze<t?(l.addClass(e.domElement,_.CLASS_TOO_TALL),e.__ul.style.height=window.innerHeight-n-ze+"px"):(l.removeClass(e.domElement,_.CLASS_TOO_TALL),e.__ul.style.height="auto")}e.__resize_handle&&m.defer(function(){e.__resize_handle.style.height=e.__ul.offsetHeight+"px"}),e.__closeButton&&(e.__closeButton.style.width=e.width+"px")},onResizeDebounced:m.debounce(function(){this.onResize()},50),remember:function(){if(m.isUndefined(ee)&&(ee=new bt,ee.domElement.innerHTML=_t),this.parent)throw new Error("You can only call remember on a top level GUI.");var e=this;m.each(Array.prototype.slice.call(arguments),function(n){e.__rememberedObjects.length===0&&Et(e),e.__rememberedObjects.indexOf(n)===-1&&e.__rememberedObjects.push(n)}),this.autoPlace&&ye(this,this.width)},getRoot:function(){for(var e=this;e.parent;)e=e.parent;return e},getSaveObject:function(){var e=this.load;return e.closed=this.closed,this.__rememberedObjects.length>0&&(e.preset=this.preset,e.remembered||(e.remembered={}),e.remembered[this.preset]=de(this)),e.folders={},m.each(this.__folders,function(n,t){e.folders[t]=n.getSaveObject()}),e},save:function(){this.load.remembered||(this.load.remembered={}),this.load.remembered[this.preset]=de(this),_e(this,!1),this.saveToLocalStorageIfPossible()},saveAs:function(e){this.load.remembered||(this.load.remembered={},this.load.remembered[ie]=de(this,!0)),this.load.remembered[e]=de(this),this.preset=e,we(this,e,!0),this.saveToLocalStorageIfPossible()},revert:function(e){m.each(this.__controllers,function(n){this.getRoot().load.remembered?je(e||this.getRoot(),n):n.setValue(n.initialValue),n.__onFinishChange&&n.__onFinishChange.call(n,n.getValue())},this),m.each(this.__folders,function(n){n.revert(n)}),e||_e(this.getRoot(),!1)},listen:function(e){var n=this.__listening.length===0;this.__listening.push(e),n&&Ke(this.__listening)},updateDisplay:function(){m.each(this.__controllers,function(e){e.updateDisplay()}),m.each(this.__folders,function(e){e.updateDisplay()})}});function xe(i,e,n){var t=document.createElement("li");return e&&t.appendChild(e),n?i.__ul.insertBefore(t,n):i.__ul.appendChild(t),i.onResize(),t}function Ge(i){l.unbind(window,"resize",i.__resizeHandler),i.saveToLocalStorageIfPossible&&l.unbind(window,"unload",i.saveToLocalStorageIfPossible)}function _e(i,e){var n=i.__preset_select[i.__preset_select.selectedIndex];e?n.innerHTML=n.value+"*":n.innerHTML=n.value}function Rt(i,e,n){if(n.__li=e,n.__gui=i,m.extend(n,{options:function(c){if(arguments.length>1){var f=n.__li.nextElementSibling;return n.remove(),ne(i,n.object,n.property,{before:f,factoryArgs:[m.toArray(arguments)]})}if(m.isArray(c)||m.isObject(c)){var p=n.__li.nextElementSibling;return n.remove(),ne(i,n.object,n.property,{before:p,factoryArgs:[c]})}},name:function(c){return n.__li.firstElementChild.firstElementChild.innerHTML=c,n},listen:function(){return n.__gui.listen(n),n},remove:function(){return n.__gui.remove(n),n}}),n instanceof ge){var t=new me(n.object,n.property,{min:n.__min,max:n.__max,step:n.__step});m.each(["updateDisplay","onChange","onFinishChange","step","min","max"],function(r){var c=n[r],f=t[r];n[r]=t[r]=function(){var p=Array.prototype.slice.call(arguments);return f.apply(t,p),c.apply(n,p)}}),l.addClass(e,"has-slider"),n.domElement.insertBefore(t.domElement,n.domElement.firstElementChild)}else if(n instanceof me){var a=function(c){if(m.isNumber(n.__min)&&m.isNumber(n.__max)){var f=n.__li.firstElementChild.firstElementChild.innerHTML,p=n.__gui.__listening.indexOf(n)>-1;n.remove();var u=ne(i,n.object,n.property,{before:n.__li.nextElementSibling,factoryArgs:[n.__min,n.__max,n.__step]});return u.name(f),p&&u.listen(),u}return c};n.min=m.compose(a,n.min),n.max=m.compose(a,n.max)}else n instanceof Ve?(l.bind(e,"click",function(){l.fakeEvent(n.__checkbox,"click")}),l.bind(n.__checkbox,"click",function(r){r.stopPropagation()})):n instanceof $e?(l.bind(e,"click",function(){l.fakeEvent(n.__button,"click")}),l.bind(e,"mouseover",function(){l.addClass(n.__button,"hover")}),l.bind(e,"mouseout",function(){l.removeClass(n.__button,"hover")})):n instanceof Ce&&(l.addClass(e,"color"),n.updateDisplay=m.compose(function(r){return e.style.borderLeftColor=n.__color.toString(),r},n.updateDisplay),n.updateDisplay());n.setValue=m.compose(function(r){return i.getRoot().__preset_select&&n.isModified()&&_e(i.getRoot(),!0),r},n.setValue)}function je(i,e){var n=i.getRoot(),t=n.__rememberedObjects.indexOf(e.object);if(t!==-1){var a=n.__rememberedObjectIndecesToControllers[t];if(a===void 0&&(a={},n.__rememberedObjectIndecesToControllers[t]=a),a[e.property]=e,n.load&&n.load.remembered){var r=n.load.remembered,c=void 0;if(r[i.preset])c=r[i.preset];else if(r[ie])c=r[ie];else return;if(c[t]&&c[t][e.property]!==void 0){var f=c[t][e.property];e.initialValue=f,e.setValue(f)}}}}function ne(i,e,n,t){if(e[n]===void 0)throw new Error('Object "'+e+'" has no property "'+n+'"');var a=void 0;if(t.color)a=new Ce(e,n);else{var r=[e,n].concat(t.factoryArgs);a=wt.apply(i,r)}t.before instanceof W&&(t.before=t.before.__li),je(i,a),l.addClass(a.domElement,"c");var c=document.createElement("span");l.addClass(c,"property-name"),c.innerHTML=a.property;var f=document.createElement("div");f.appendChild(c),f.appendChild(a.domElement);var p=xe(i,f,t.before);return l.addClass(p,_.CLASS_CONTROLLER_ROW),a instanceof Ce?l.addClass(p,"color"):l.addClass(p,dt(a.getValue())),Rt(i,p,a),i.__controllers.push(a),a}function Y(i,e){return document.location.href+"."+e}function we(i,e,n){var t=document.createElement("option");t.innerHTML=e,t.value=e,i.__preset_select.appendChild(t),n&&(i.__preset_select.selectedIndex=i.__preset_select.length-1)}function Ne(i,e){e.style.display=i.useLocalStorage?"block":"none"}function Et(i){var e=i.__save_row=document.createElement("li");l.addClass(i.domElement,"has-save"),i.__ul.insertBefore(e,i.__ul.firstChild),l.addClass(e,"save-row");var n=document.createElement("span");n.innerHTML="&nbsp;",l.addClass(n,"button gears");var t=document.createElement("span");t.innerHTML="Save",l.addClass(t,"button"),l.addClass(t,"save");var a=document.createElement("span");a.innerHTML="New",l.addClass(a,"button"),l.addClass(a,"save-as");var r=document.createElement("span");r.innerHTML="Revert",l.addClass(r,"button"),l.addClass(r,"revert");var c=i.__preset_select=document.createElement("select");if(i.load&&i.load.remembered?m.each(i.load.remembered,function(d,h){we(i,h,h===i.preset)}):we(i,ie,!1),l.bind(c,"change",function(){for(var d=0;d<i.__preset_select.length;d++)i.__preset_select[d].innerHTML=i.__preset_select[d].value;i.preset=this.value}),e.appendChild(c),e.appendChild(n),e.appendChild(t),e.appendChild(a),e.appendChild(r),J){var f=document.getElementById("dg-local-explain"),p=document.getElementById("dg-local-storage"),u=document.getElementById("dg-save-locally");u.style.display="block",localStorage.getItem(Y(i,"isLocal"))==="true"&&p.setAttribute("checked","checked"),Ne(i,f),l.bind(p,"change",function(){i.useLocalStorage=!i.useLocalStorage,Ne(i,f)})}var C=document.getElementById("dg-new-constructor");l.bind(C,"keydown",function(d){d.metaKey&&(d.which===67||d.keyCode===67)&&ee.hide()}),l.bind(n,"click",function(){C.innerHTML=JSON.stringify(i.getSaveObject(),void 0,2),ee.show(),C.focus(),C.select()}),l.bind(t,"click",function(){i.save()}),l.bind(a,"click",function(){var d=prompt("Enter a new preset name.");d&&i.saveAs(d)}),l.bind(r,"click",function(){i.revert()})}function At(i){var e=void 0;i.__resize_handle=document.createElement("div"),m.extend(i.__resize_handle.style,{width:"6px",marginLeft:"-3px",height:"200px",cursor:"ew-resize",position:"absolute"});function n(r){return r.preventDefault(),i.width+=e-r.clientX,i.onResize(),e=r.clientX,!1}function t(){l.removeClass(i.__closeButton,_.CLASS_DRAG),l.unbind(window,"mousemove",n),l.unbind(window,"mouseup",t)}function a(r){return r.preventDefault(),e=r.clientX,l.addClass(i.__closeButton,_.CLASS_DRAG),l.bind(window,"mousemove",n),l.bind(window,"mouseup",t),!1}l.bind(i.__resize_handle,"mousedown",a),l.bind(i.__closeButton,"mousedown",a),i.domElement.insertBefore(i.__resize_handle,i.domElement.firstElementChild)}function ye(i,e){i.domElement.style.width=e+"px",i.__save_row&&i.autoPlace&&(i.__save_row.style.width=e+"px"),i.__closeButton&&(i.__closeButton.style.width=e+"px")}function de(i,e){var n={};return m.each(i.__rememberedObjects,function(t,a){var r={},c=i.__rememberedObjectIndecesToControllers[a];m.each(c,function(f,p){r[p]=e?f.initialValue:f.getValue()}),n[a]=r}),n}function Pt(i){for(var e=0;e<i.__preset_select.length;e++)i.__preset_select[e].value===i.preset&&(i.__preset_select.selectedIndex=e)}function Ke(i){i.length!==0&&vt.call(window,function(){Ke(i)}),m.each(i,function(e){e.updateDisplay()})}var te=_;te.TEXT_CLOSED="收起控件";te.TEXT_OPEN="展开控件";class Dt extends te{constructor(e={}){const n={autoPlace:!1,width:275,...e};super(n),this.setLocale(),this.injectCustomStyles(),this.enableTooltips()}injectCustomStyles(){if(document.getElementById("my-dat-gui-custom-style"))return;const e=document.createElement("style");e.id="my-dat-gui-custom-style",e.textContent=`
      /* 优化 dat.GUI 标签与复选框间距 */
      .dg .cr .property-name {
        width: 60% !important;
