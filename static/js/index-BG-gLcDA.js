import{c as B,o as _,D as H,C as i}from"./cesium-RVgkKbYd.js";import{C as M}from"./cesium-pNEfRpPT.js";import{G as T}from"./lil-gui.esm-ItvJbUpV.js";import{_ as W,r as V,T as $,F as R,M as k,o as z,m as G,f as U,h as L,i as j,H as N}from"./index-CrInfhqG.js";import"./index-CIQDDkuh.js";const Y=`<template>
  <demo-box :codeBlocks>
...
`,J={class:"box",ref:"viewerRef"},O=N({name:"SectorDraw"}),Q=Object.assign(O,{setup(K){const y=V([{fileName:"@/views/geometries/sectorDraw/index.vue",rawCode:Y,language:"html"},{fileName:"@/utils/cesium.js",rawCode:M,language:"javascript"}]),g=$("viewerRef");let t=null,p=null,r=null,u=null,m=[];const n={longitude:-112.210693,latitude:36.0994841,radius:3e3,startAngle:0,endAngle:90,height:0,extrudedHeight:1e3,showPoints:!0,color:"#ffffff",alpha:.5,resetView:()=>{t&&t.entities.values.length>0&&t.zoomTo(t.entities)}};R(()=>{p=setTimeout(()=>{x()},0)});function b(o,e,s,a=0,f=90,E=1){const d=[];d.push(o),d.push(e);let c=f-a;c<0&&(c+=360),c===0&&a!==f&&(c=360);for(let h=0;h<=c;h+=E){const C=(a+h)%360*Math.PI/180,P=s*Math.sin(C),S=s*Math.cos(C),w=6356725+21412*(90-e)/90,D=w*Math.cos(e*Math.PI/180),F=o+P/D*180/Math.PI,I=e+S/w*180/Math.PI;d.push(F),d.push(I)}return d}function l(){if(!t)return;u&&(t.entities.remove(u),u=null),m.forEach(e=>t.entities.remove(e)),m=[];const o=b(n.longitude,n.latitude,n.radius,n.startAngle,n.endAngle);i.Color.fromCssColorString(n.color).withAlpha(n.alpha),u=t.entities.add({name:"三维立体拉伸扇形",description:`
      <table style="width: 100%; border-collapse: collapse;">
    ...
    `,polygon:{hierarchy:new i.PolygonHierarchy(i.Cartesian3.fromDegreesArray(o)),height:n.height,extrudedHeight:n.height+n.extrudedHeight,outline:!0,outlineColor:i.Color.WHITE.withAlpha(.6),outlineWidth:2,material:new i.ColorMaterialProperty(new i.CallbackProperty(()=>i.Color.fromCssColorString(n.color).withAlpha(n.alpha),!1))}});for(let e=0;e<o.length;e+=2){const s=e===0,a=t.entities.add({name:s?"扇形圆心点":`弧段采样点_${e/2}`,show:n.showPoints,position:i.Cartesian3.fromDegrees(o[e],o[e+1],n.height+n.extrudedHeight),point:{color:s?i.Color.RED:i.Color.SKYBLUE,pixelSize:s?12:8,outlineColor:s?i.Color.WHITE:i.Color.YELLOW,outlineWidth:2}});m.push(a)}}function v(o){m.forEach(e=>{e.show=o})}function x(){t=B(g.value,{shadows:!0}),_(t,{msaaSamples:4,enableFxaa:!0}),t.scene.globe.depthTestAgainstTerrain=!0,l(),t.zoomTo(t.entities),A()}function A(){r=new T({container:g.value,title:"三维立体扇形控制",width:300}),r.domElement.style.position="absolute",r.domElement.style.top="10px",r.domElement.style.right="10px",r.domElement.style.zIndex="5";const o=r.addFolder("位置与尺寸");o.add(n,"radius",500,2e4,100).name("扇形半径 (米)").onChange(()=>l()),o.add(n,"startAngle",0,360,1).name("起始方位角 (°)").onChange(()=>l()),o.add(n,"endAngle",0,360,1).name("终止方位角 (°)").onChange(()=>l()),o.add(n,"extrudedHeight",0,5e3,100).name("拉伸高度 (米)").onChange(()=>l());const e=r.addFolder("样式与显隐");e.addColor(n,"color").name("扇形颜色"),e.add(n,"alpha",0,1,.05).name("不透明度"),e.add(n,"showPoints").name("显示采样点").onChange(s=>v(s)),r.add(n,"resetView").name("重置聚焦视角")}return k(()=>{p&&clearTimeout(p),r&&(r.destroy(),r=null),t&&(t.destroy(),t=null)}),(o,e)=>(z(),G(H,{codeBlocks:j(y)},{default:U(()=>[L("div",J,null,512)]),_:1},8,["codeBlocks"]))}}),sn=W(Q,[["__scopeId","data-v-375ef226"]]);export{sn as default};
