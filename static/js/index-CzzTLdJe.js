import{c as M,o as B,D as W,C as i}from"./cesium-Cuk6WcZT.js";import{C as _}from"./cesium-pNEfRpPT.js";import{M as H}from"./datGUI-BQnuHFxa.js";import{_ as T,r as V,T as $,F as U,M as G,o as R,m as k,f as z,h as L,i as j,H as N}from"./index-BXzjRK59.js";import"./index-DeOmIXP4.js";const Y=`<template>
  <demo-box :codeBlocks>
...
`,J={class:"box",ref:"viewerRef"},O=N({name:"SectorDraw"}),Q=Object.assign(O,{setup(K){const b=V([{fileName:"@/views/geometries/sectorDraw/index.vue",rawCode:Y,language:"html"},{fileName:"@/utils/cesium.js",rawCode:_,language:"javascript"}]),g=$("viewerRef");let t=null,p=null,s=null,u=null,m=[];const n={longitude:-112.210693,latitude:36.0994841,radius:3e3,startAngle:0,endAngle:90,height:0,extrudedHeight:1e3,showPoints:!0,color:"#ffffff",alpha:.5,resetView:()=>{t&&t.entities.values.length>0&&t.zoomTo(t.entities)}};U(()=>{p=setTimeout(()=>{A()},0)});function y(o,e,r,a=0,f=90,E=1){const d=[];d.push(o),d.push(e);let c=f-a;c<0&&(c+=360),c===0&&a!==f&&(c=360);for(let h=0;h<=c;h+=E){const C=(a+h)%360*Math.PI/180,P=r*Math.sin(C),D=r*Math.cos(C),w=6356725+21412*(90-e)/90,S=w*Math.cos(e*Math.PI/180),F=o+P/S*180/Math.PI,I=e+D/w*180/Math.PI;d.push(F),d.push(I)}return d}function l(){if(!t)return;u&&(t.entities.remove(u),u=null),m.forEach(e=>t.entities.remove(e)),m=[];const o=y(n.longitude,n.latitude,n.radius,n.startAngle,n.endAngle);i.Color.fromCssColorString(n.color).withAlpha(n.alpha),u=t.entities.add({name:"三维立体拉伸扇形",description:`
      <table style="width: 100%; border-collapse: collapse;">
    ...
    `,polygon:{hierarchy:new i.PolygonHierarchy(i.Cartesian3.fromDegreesArray(o)),height:n.height,extrudedHeight:n.height+n.extrudedHeight,outline:!0,outlineColor:i.Color.WHITE.withAlpha(.6),outlineWidth:2,material:new i.ColorMaterialProperty(new i.CallbackProperty(()=>i.Color.fromCssColorString(n.color).withAlpha(n.alpha),!1))}});for(let e=0;e<o.length;e+=2){const r=e===0,a=t.entities.add({name:r?"扇形圆心点":`弧段采样点_${e/2}`,show:n.showPoints,position:i.Cartesian3.fromDegrees(o[e],o[e+1],n.height+n.extrudedHeight),point:{color:r?i.Color.RED:i.Color.SKYBLUE,pixelSize:r?12:8,outlineColor:r?i.Color.WHITE:i.Color.YELLOW,outlineWidth:2}});m.push(a)}}function v(o){m.forEach(e=>{e.show=o})}function A(){t=M(g.value,{shadows:!0}),B(t,{msaaSamples:4,enableFxaa:!0}),t.scene.globe.depthTestAgainstTerrain=!0,l(),t.zoomTo(t.entities),x()}function x(){s=new H({width:330,labelWidth:.35}),s.modifyPosition(g.value);const o=s.addFolder("位置与尺寸");o.add(n,"radius",500,2e4,100).name("扇形半径 (米)").onChange(()=>l()),o.add(n,"startAngle",0,360,1).name("起始方位角 (°)").onChange(()=>l()),o.add(n,"endAngle",0,360,1).name("终止方位角 (°)").onChange(()=>l()),o.add(n,"extrudedHeight",0,5e3,100).name("拉伸高度 (米)").onChange(()=>l()),o.open();const e=s.addFolder("样式与显隐");e.addColor(n,"color").name("扇形颜色"),e.add(n,"alpha",0,1,.05).name("不透明度"),e.add(n,"showPoints").name("显示采样点").onChange(r=>v(r)),e.open(),s.add(n,"resetView").name("重置聚焦视角")}return G(()=>{p&&clearTimeout(p),s&&(s.destroy(),s=null),t&&(t.destroy(),t=null)}),(o,e)=>(R(),k(W,{codeBlocks:j(b)},{default:z(()=>[L("div",J,null,512)]),_:1},8,["codeBlocks"]))}}),sn=T(Q,[["__scopeId","data-v-b8746bda"]]);export{sn as default};
