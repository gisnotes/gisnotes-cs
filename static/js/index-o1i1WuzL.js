import{C as i,c,D as p}from"./cesium-C3e13GYG.js";import{_ as C,r as h,T as d,F as _,M as k,o as B,m as M,f as g,h as a,i as R,H as x}from"./index-DuSIVT5r.js";import"./index-CTKpwe3s.js";const y=`<template>\r
...
`,S={class:"multiple-synced-views"},V={class:"viewer-container",ref:"viewer3DRef"},E={class:"viewer-container",ref:"viewer2DRef"},b=x({name:"MultipleSyncedViews"}),U=Object.assign(b,{setup(T){const m=h([{fileName:"@/views/view/multipleSyncedViews/index.vue",rawCode:y,language:"html"}]),w=d("viewer3DRef"),v=d("viewer2DRef");let e=null,r=null,s=null;const u="https://www.unpkg.com/cesium@1.144.0/Build/Cesium/";window.CESIUM_BASE_URL=u;let t;const l=()=>{if(!e||!r)return;const o=new i.Cartesian2(Math.floor(e.canvas.clientWidth/2),Math.floor(e.canvas.clientHeight/2)),n=e.scene.camera.pickEllipsoid(o);if(i.defined(n)&&(t=n),!t)return;const D=i.Cartesian3.distance(t,e.scene.camera.positionWC);r.scene.camera.lookAt(t,new i.Cartesian3(0,0,D))};_(()=>{s=setTimeout(()=>{f()},0)});function f(){const o=new i.ClockViewModel;e=c(w.value,{clockViewModel:o}),r=c(v.value,{clockViewModel:o,sceneMode:i.SceneMode.SCENE2D}),e.camera.changed.addEventListener(l),e.camera.percentageChanged=.01;const n=r.scene.screenSpaceCameraController;n.enableRotate=!1,n.enableTranslate=!1,n.enableZoom=!1,n.enableTilt=!1,n.enableLook=!1}return k(()=>{s&&clearTimeout(s),e&&(e.camera.changed.removeEventListener(l),e.destroy()),r&&r.destroy()}),(o,n)=>(B(),M(p,{codeBlocks:R(m)},{default:g(()=>[a("div",S,[a("div",V,null,512),a("div",E,null,512)])]),_:1},8,["codeBlocks"]))}}),I=C(U,[["__scopeId","data-v-73166481"]]);export{I as default};
