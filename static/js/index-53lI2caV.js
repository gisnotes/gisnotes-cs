import{c as ke,o as Se,C as e,s as _e,a as Ve,b as V,d as H,e as O,D as Ye,f as Y,g as Ke}from"./cesium-AZsM1J9I.js";import{C as Ze}from"./cesium-Cc-VHwZL.js";import{M as je}from"./datGUI-BDf2v8uN.js";import{_ as qe,r as Qe,T as Xe,F as $e,M as Je,o as en,m as nn,f as an,h as on,i as rn,H as ln}from"./index-DZjXdyWp.js";import"./index-B4v4PTIv.js";const tn=`<template>
  <demo-box :codeBlocks>
...
`,sn={class:"box",ref:"viewerRef"},dn=ln({name:"GeometriesDraw"}),mn=Object.assign(dn,{setup(un){const x="/Sandcastle2/images/Cesium_Logo_Color.jpg",K=Qe([{fileName:"@/views/geometries/geometriesDraw/index.vue",rawCode:tn,language:"html"},{fileName:"@/utils/cesium.js",rawCode:Ze,language:"javascript"}]),U=Xe("viewerRef");let a=null,F=null,t=null,T=null;$e(()=>{F=setTimeout(()=>{Z()},0)});function Z(){a=ke(U.value),Se(a,{msaaSamples:4,enableFxaa:!0});const o=a.entities.add({name:"蓝色盒子",position:e.Cartesian3.fromDegrees(-114,40,3e5),box:{dimensions:new e.Cartesian3(4e5,3e5,5e5),material:e.Color.BLUE}}),P=a.entities.add({name:"黑边红色半透明盒子",show:!1,position:e.Cartesian3.fromDegrees(-107,40,3e5),box:{dimensions:new e.Cartesian3(4e5,3e5,5e5),material:e.Color.RED.withAlpha(.5),outline:!0,outlineColor:e.Color.BLACK}}),i=a.entities.add({name:"黄色线框盒子",show:!1,position:e.Cartesian3.fromDegrees(-100,40,3e5),box:{dimensions:new e.Cartesian3(4e5,3e5,5e5),fill:!1,outline:!0,outlineColor:e.Color.YELLOW}}),r=a.entities.add({name:"带外边框的高空绿色圆",show:!1,position:e.Cartesian3.fromDegrees(-111,40,15e4),ellipse:{semiMinorAxis:3e5,semiMajorAxis:3e5,height:2e5,material:e.Color.GREEN,outline:!0}}),R=a.entities.add({name:"地表红色半透明椭圆",show:!1,position:e.Cartesian3.fromDegrees(-103,40),ellipse:{semiMinorAxis:25e4,semiMajorAxis:4e5,material:e.Color.RED.withAlpha(.5)}}),v=a.entities.add({name:"蓝色半透明旋转拉伸柱体椭圆",show:!1,position:e.Cartesian3.fromDegrees(-95,40,1e5),ellipse:{semiMinorAxis:15e4,semiMajorAxis:3e5,extrudedHeight:2e5,rotation:e.Math.toRadians(45),material:e.Color.BLUE.withAlpha(.5),outline:!0}}),D=a.entities.add({name:"地表圆角红色半透明走廊",show:!1,corridor:{positions:e.Cartesian3.fromDegreesArray([-100,40,-105,40,-105,35]),width:2e5,material:e.Color.RED.withAlpha(.5)}}),L=a.entities.add({name:"高空尖角带边框绿色走廊",show:!1,corridor:{positions:e.Cartesian3.fromDegreesArray([-90,40,-95,40,-95,35]),height:1e5,width:2e5,cornerType:e.CornerType.MITERED,material:e.Color.GREEN,outline:!0}}),m=a.entities.add({name:"白边斜角蓝色立体走廊",show:!1,corridor:{positions:e.Cartesian3.fromDegreesArray([-80,40,-85,40,-85,35]),height:2e5,extrudedHeight:1e5,width:2e5,cornerType:e.CornerType.BEVELED,material:e.Color.BLUE.withAlpha(.5),outline:!0,outlineColor:e.Color.WHITE}}),A=a.entities.add({name:"黑边绿色半透明圆柱体",show:!1,position:e.Cartesian3.fromDegrees(-100,40,2e5),cylinder:{length:4e5,topRadius:2e5,bottomRadius:2e5,material:e.Color.GREEN.withAlpha(.5),outline:!0,outlineColor:e.Color.BLACK}}),I=a.entities.add({name:"红色圆锥体",show:!1,position:e.Cartesian3.fromDegrees(-105,40,2e5),cylinder:{length:4e5,topRadius:0,bottomRadius:2e5,material:e.Color.RED}}),u=e.Cartesian3.fromDegrees(-95,45,3e5),C=a.entities.add({name:"土星本体",show:!1,position:u,ellipsoid:{radii:new e.Cartesian3(2e5,2e5,2e5),material:new e.Color(.95,.82,.49)}}),E=a.entities.add({name:"土星内环",show:!1,position:u,orientation:e.Transforms.headingPitchRollQuaternion(u,new e.HeadingPitchRoll(e.Math.toRadians(30),e.Math.toRadians(30),0)),ellipsoid:{radii:new e.Cartesian3(4e5,4e5,4e5),innerRadii:new e.Cartesian3(3e5,3e5,3e5),minimumCone:e.Math.toRadians(89.8),maximumCone:e.Math.toRadians(90.2),material:new e.Color(.95,.82,.49,.5)}}),b=a.entities.add({name:"土星外环",show:!1,position:u,orientation:e.Transforms.headingPitchRollQuaternion(u,new e.HeadingPitchRoll(e.Math.toRadians(30),e.Math.toRadians(30),0)),ellipsoid:{radii:new e.Cartesian3(46e4,46e4,46e4),innerRadii:new e.Cartesian3(415e3,415e3,415e3),minimumCone:e.Math.toRadians(89.8),maximumCone:e.Math.toRadians(90.2),material:new e.Color(.95,.82,.49,.5)}}),h=a.entities.add({name:"圆顶球壳",show:!1,position:e.Cartesian3.fromDegrees(-120,40),ellipsoid:{radii:new e.Cartesian3(2e5,2e5,2e5),maximumCone:e.Math.PI_OVER_TWO,material:e.Color.BLUE.withAlpha(.3),outline:!0}}),M=a.entities.add({name:"带内半径的圆顶",show:!1,position:e.Cartesian3.fromDegrees(-114,40),ellipsoid:{radii:new e.Cartesian3(25e4,2e5,15e4),innerRadii:new e.Cartesian3(1e5,8e4,6e4),maximumCone:e.Math.PI_OVER_TWO,material:e.Color.RED.withAlpha(.3),outline:!0}}),w=a.entities.add({name:"顶部裁剪圆顶",show:!1,position:e.Cartesian3.fromDegrees(-108,40),ellipsoid:{radii:new e.Cartesian3(2e5,2e5,2e5),innerRadii:new e.Cartesian3(1e5,1e5,1e5),minimumCone:e.Math.toRadians(20),maximumCone:e.Math.PI_OVER_TWO,material:e.Color.YELLOW.withAlpha(.3),outline:!0}}),n=a.entities.add({name:"上下裁剪球壳",show:!1,position:e.Cartesian3.fromDegrees(-102,40,14e4),ellipsoid:{radii:new e.Cartesian3(2e5,2e5,2e5),innerRadii:new e.Cartesian3(1e5,1e5,1e5),minimumCone:e.Math.toRadians(60),maximumCone:e.Math.toRadians(140),material:e.Color.DARKCYAN.withAlpha(.3),outline:!0}}),g=a.entities.add({name:"碗状结构",show:!1,position:e.Cartesian3.fromDegrees(-96,39.5,2e5),ellipsoid:{radii:new e.Cartesian3(2e5,2e5,2e5),innerRadii:new e.Cartesian3(18e4,18e4,18e4),minimumCone:e.Math.toRadians(110),material:e.Color.GREEN.withAlpha(.3),outline:!0}}),q=a.entities.add({name:"时钟角度裁剪",show:!1,position:e.Cartesian3.fromDegrees(-90,39),ellipsoid:{radii:new e.Cartesian3(2e5,2e5,2e5),innerRadii:new e.Cartesian3(15e4,15e4,15e4),minimumClock:e.Math.toRadians(-90),maximumClock:e.Math.toRadians(180),minimumCone:e.Math.toRadians(20),maximumCone:e.Math.toRadians(70),material:e.Color.BLUE.withAlpha(.3),outline:!0}}),Q=a.entities.add({name:"局部半球圆顶",show:!1,position:e.Cartesian3.fromDegrees(-84,38.5),ellipsoid:{radii:new e.Cartesian3(2e5,2e5,2e5),minimumClock:e.Math.toRadians(-90),maximumClock:e.Math.toRadians(180),maximumCone:e.Math.toRadians(90),material:e.Color.RED.withAlpha(.3),outline:!0}}),N=e.Cartesian3.fromDegrees(-102,35,2e4),X=a.entities.add({name:"楔形结构",show:!1,position:N,orientation:e.Transforms.headingPitchRollQuaternion(N,new e.HeadingPitchRoll(e.Math.PI/1.5,0,0)),ellipsoid:{radii:new e.Cartesian3(5e5,5e5,5e5),innerRadii:new e.Cartesian3(1e4,1e4,1e4),minimumClock:e.Math.toRadians(-15),maximumClock:e.Math.toRadians(15),minimumCone:e.Math.toRadians(75),maximumCone:e.Math.toRadians(105),material:e.Color.DARKCYAN.withAlpha(.3),outline:!0}}),$=a.entities.add({name:"局部椭球体",show:!1,position:e.Cartesian3.fromDegrees(-95,34),ellipsoid:{radii:new e.Cartesian3(3e5,3e5,3e5),innerRadii:new e.Cartesian3(7e4,7e4,7e4),minimumClock:e.Math.toRadians(180),maximumClock:e.Math.toRadians(400),maximumCone:e.Math.toRadians(90),material:e.Color.DARKCYAN.withAlpha(.3),outline:!0}}),J=a.entities.add({name:"蓝色平面",show:!1,position:e.Cartesian3.fromDegrees(-114,40,3e5),plane:{plane:new e.Plane(e.Cartesian3.UNIT_X,0),dimensions:new e.Cartesian2(4e5,3e5),material:e.Color.BLUE}}),ee=a.entities.add({name:"黑边红色半透明平面",show:!1,position:e.Cartesian3.fromDegrees(-107,40,3e5),plane:{plane:new e.Plane(e.Cartesian3.UNIT_Y,0),dimensions:new e.Cartesian2(4e5,3e5),material:e.Color.RED.withAlpha(.5),outline:!0,outlineColor:e.Color.BLACK}}),ne=a.entities.add({name:"黄色线框平面",show:!1,position:e.Cartesian3.fromDegrees(-100,40,3e5),plane:{plane:new e.Plane(e.Cartesian3.UNIT_Z,0),dimensions:new e.Cartesian2(4e5,3e5),fill:!1,outline:!0,outlineColor:e.Color.YELLOW}}),ae=a.entities.add({name:"红色半透明矩形",show:!1,rectangle:{coordinates:e.Rectangle.fromDegrees(-110,20,-80,25),material:e.Color.RED.withAlpha(.5)}}),oe=a.entities.add({name:"黑边高空旋转拉伸绿色矩形",show:!1,rectangle:{coordinates:e.Rectangle.fromDegrees(-110,30,-100,40),material:e.Color.GREEN.withAlpha(.5),rotation:e.Math.toRadians(45),extrudedHeight:3e5,height:1e5,outline:!0,outlineColor:e.Color.BLACK}});let W=e.Math.toRadians(30);function k(){return W+=.005,W}const ie=a.entities.add({name:"动态旋转纹理矩形",show:!1,rectangle:{coordinates:e.Rectangle.fromDegrees(-92,30,-76,40),material:x,rotation:new e.CallbackProperty(k,!1),stRotation:new e.CallbackProperty(k,!1),classificationType:e.ClassificationType.BOTH}}),re=a.entities.add({name:"地表红色多边形",show:!1,polygon:{hierarchy:e.Cartesian3.fromDegreesArray([-115,37,-115,32,-107,33,-102,31,-102,35]),material:e.Color.RED}}),le=a.entities.add({name:"绿色拉伸多边形",show:!1,polygon:{hierarchy:e.Cartesian3.fromDegreesArray([-108,42,-100,42,-104,40]),extrudedHeight:5e5,material:e.Color.GREEN,closeTop:!1,closeBottom:!1}}),te=a.entities.add({name:"纹理拉伸多边形",show:!1,polygon:{hierarchy:e.Cartesian3.fromDegreesArrayHeights([-118.4,40.4,5e4,-118.4,37,3e4,-114.2,38,35e3,-108,37,3e4,-108,40.4,5e4]),textureCoordinates:{positions:[new e.Cartesian2(0,1),new e.Cartesian2(0,0),new e.Cartesian2(.5,0),new e.Cartesian2(1,0),new e.Cartesian2(1,1)]},perPositionHeight:!0,extrudedHeight:0,material:x}}),se=a.entities.add({name:"带孔纹理多边形",show:!1,polygon:{hierarchy:{positions:e.Cartesian3.fromDegreesArrayHeights([-130,40,5e4,-130,36,3e4,-125,37,35e3,-120,36,3e4,-120,40,5e4]),holes:[{positions:e.Cartesian3.fromDegreesArrayHeights([-128,39.2,46e3,-128,38.6,42e3,-127,38.6,42e3,-127,39.2,46e3])}]},textureCoordinates:{positions:[new e.Cartesian2(0,1),new e.Cartesian2(0,0),new e.Cartesian2(.5,0),new e.Cartesian2(1,0),new e.Cartesian2(1,1)],holes:[{positions:[new e.Cartesian2(.2,.8),new e.Cartesian2(.2,.6),new e.Cartesian2(.4,.6),new e.Cartesian2(.4,.8)]}]},perPositionHeight:!0,material:x}}),de=a.entities.add({name:"带点高度橙色多边形",show:!1,polygon:{hierarchy:e.Cartesian3.fromDegreesArrayHeights([-108,25,1e5,-100,25,1e5,-100,30,1e5,-108,30,3e5]),extrudedHeight:0,perPositionHeight:!0,material:e.Color.ORANGE.withAlpha(.5),outline:!0,outlineColor:e.Color.BLACK}}),me=a.entities.add({name:"带多孔嵌套蓝色多边形",show:!1,polygon:{hierarchy:{positions:e.Cartesian3.fromDegreesArray([-99,30,-85,30,-85,40,-99,40]),holes:[{positions:e.Cartesian3.fromDegreesArray([-97,31,-97,39,-87,39,-87,31]),holes:[{positions:e.Cartesian3.fromDegreesArray([-95,33,-89,33,-89,37,-95,37]),holes:[{positions:e.Cartesian3.fromDegreesArray([-93,34,-91,34,-91,36,-93,36])}]}]}]},material:e.Color.BLUE.withAlpha(.5),height:0,outline:!0}}),ue=a.entities.add({name:"青色垂直多边形",show:!1,polygon:{hierarchy:e.Cartesian3.fromDegreesArrayHeights([-90,41,0,-85,41,5e5,-80,41,0]),perPositionHeight:!0,material:e.Color.CYAN.withAlpha(.5),outline:!0,outlineColor:e.Color.BLACK}}),Ce=a.entities.add({name:"等角航线紫色多边形",show:!1,polygon:{hierarchy:e.Cartesian3.fromDegreesArray([-120,45,-80,45,-80,55,-120,55]),extrudedHeight:5e4,material:e.Color.PURPLE,outline:!0,outlineColor:e.Color.MAGENTA,arcType:e.ArcType.RHUMB}}),he=a.entities.add({name:"贴地红色折线",show:!1,polyline:{positions:e.Cartesian3.fromDegreesArray([-75,35,-125,35]),width:5,material:e.Color.RED,clampToGround:!0}}),ge=a.entities.add({name:"绿色等角航线",show:!1,polyline:{positions:e.Cartesian3.fromDegreesArray([-75,35,-125,35]),width:5,arcType:e.ArcType.RHUMB,material:e.Color.GREEN}}),ce=a.entities.add({name:"地表发光蓝色折线",show:!1,polyline:{positions:e.Cartesian3.fromDegreesArray([-75,37,-125,37]),width:10,material:new e.PolylineGlowMaterialProperty({glowPower:.2,taperPower:.5,color:e.Color.CORNFLOWERBLUE})}}),pe=a.entities.add({name:"高空黑边橙色双色折线",show:!1,polyline:{positions:e.Cartesian3.fromDegreesArrayHeights([-75,39,25e4,-125,39,25e4]),width:5,material:new e.PolylineOutlineMaterialProperty({color:e.Color.ORANGE,outlineWidth:2,outlineColor:e.Color.BLACK})}}),we=a.entities.add({name:"高空紫光箭头折线",show:!1,polyline:{positions:e.Cartesian3.fromDegreesArrayHeights([-75,43,5e5,-125,43,5e5]),width:10,arcType:e.ArcType.NONE,material:new e.PolylineArrowMaterialProperty(e.Color.PURPLE)}}),fe=a.entities.add({name:"高空虚线折线",show:!1,polyline:{positions:e.Cartesian3.fromDegreesArrayHeights([-75,45,5e5,-125,45,5e5]),width:4,material:new e.PolylineDashMaterialProperty({color:e.Color.CYAN})}}),ye=a.entities.add({name:"红色高空虚线",show:!1,polyline:{positions:e.Cartesian3.fromDegreesArrayHeights([-75,38,25e4,-125,38,25e4]),width:5,material:new e.PolylineDashMaterialProperty({color:e.Color.RED})}}),Re=a.entities.add({name:"双色带间隙蓝黄虚线",show:!1,polyline:{positions:e.Cartesian3.fromDegreesArrayHeights([-75,40,25e4,-125,40,25e4]),width:30,material:new e.PolylineDashMaterialProperty({color:e.Color.BLUE,gapColor:e.Color.YELLOW})}}),xe=a.entities.add({name:"短段节橙色虚线",show:!1,polyline:{positions:e.Cartesian3.fromDegreesArrayHeights([-75,42,25e4,-125,42,25e4]),width:5,material:new e.PolylineDashMaterialProperty({color:e.Color.ORANGE,dashLength:8})}}),Pe=a.entities.add({name:"自定模式青色虚线",show:!1,polyline:{positions:e.Cartesian3.fromDegreesArrayHeights([-75,44,25e4,-125,44,25e4]),width:10,material:new e.PolylineDashMaterialProperty({color:e.Color.CYAN,dashPattern:parseInt("110000001111",2)})}}),ve=a.entities.add({name:"自定点划模式黄色虚线",show:!1,polyline:{positions:e.Cartesian3.fromDegreesArrayHeights([-75,46,25e4,-125,46,25e4]),width:10,material:new e.PolylineDashMaterialProperty({color:e.Color.YELLOW,dashPattern:parseInt("1010101010101010",2)})}});function De(s){const l=[];for(let d=0;d<360;d++){const p=e.Math.toRadians(d);l.push(new e.Cartesian2(s*Math.cos(p),s*Math.sin(p)))}return l}function Ae(s,l,d){const p=Math.PI/s,B=2*s,y=new Array(B);for(let c=0;c<B;c++){const G=c%2===0?l:d;y[c]=new e.Cartesian2(Math.cos(c*p)*G,Math.sin(c*p)*G)}return y}const Ie=a.entities.add({name:"红色管道圆角柱体",show:!1,polylineVolume:{positions:e.Cartesian3.fromDegreesArray([-85,32,-85,36,-89,36]),shape:De(6e4),material:e.Color.RED}}),Ee=a.entities.add({name:"绿色方形斜角带边框柱体",show:!1,polylineVolume:{positions:e.Cartesian3.fromDegreesArrayHeights([-90,32,0,-90,36,1e5,-94,36,0]),shape:[new e.Cartesian2(-5e4,-5e4),new e.Cartesian2(5e4,-5e4),new e.Cartesian2(5e4,5e4),new e.Cartesian2(-5e4,5e4)],cornerType:e.CornerType.BEVELED,material:e.Color.GREEN.withAlpha(.5),outline:!0,outlineColor:e.Color.BLACK}}),be=a.entities.add({name:"蓝色星形尖角柱体",show:!1,polylineVolume:{positions:e.Cartesian3.fromDegreesArrayHeights([-95,32,0,-95,36,1e5,-99,36,2e5]),shape:Ae(7,7e4,5e4),cornerType:e.CornerType.MITERED,material:e.Color.BLUE}}),Te=a.entities.add({name:"高空红色墙体",show:!1,wall:{positions:e.Cartesian3.fromDegreesArrayHeights([-115,44,2e5,-90,44,2e5]),minimumHeights:[1e5,1e5],material:e.Color.RED}}),Le=a.entities.add({name:"带边框地表绿色墙体",show:!1,wall:{positions:e.Cartesian3.fromDegreesArrayHeights([-107,43,1e5,-97,43,1e5,-97,40,1e5,-107,40,1e5,-107,43,1e5]),material:e.Color.GREEN,outline:!0}}),Me=a.entities.add({name:"锯齿起伏黑边蓝色半透明墙体",show:!1,wall:{positions:e.Cartesian3.fromDegreesArray([-115,50,-112.5,50,-110,50,-107.5,50,-105,50,-102.5,50,-100,50,-97.5,50,-95,50,-92.5,50,-90,50]),maximumHeights:[1e5,2e5,1e5,2e5,1e5,2e5,1e5,2e5,1e5,2e5,1e5],minimumHeights:[0,1e5,0,1e5,0,1e5,0,1e5,0,1e5,0],material:e.Color.BLUE.withAlpha(.5),outline:!0,outlineColor:e.Color.BLACK}});_e(a.scene)||console.warn("当前平台不支持地表贴地折线 Z-Index，该属性将被忽略"),Ve(a.scene)||console.warn("当前平台不支持地表贴图多边形材质 Z-Index，该属性将被忽略");const ze=a.entities.add({name:"红色矩形 (zIndex 1)",show:!1,rectangle:{coordinates:e.Rectangle.fromDegrees(-110,20,-100.5,30),material:e.Color.RED,zIndex:1}}),Be=a.entities.add({name:"纹理矩形 (zIndex 2)",show:!1,rectangle:{coordinates:e.Rectangle.fromDegrees(-112,25,-102.5,35),material:x,zIndex:2}}),Ge=a.entities.add({name:"蓝色矩形 (zIndex 3)",show:!1,rectangle:{coordinates:e.Rectangle.fromDegrees(-110,31,-100.5,41),material:e.Color.BLUE,zIndex:3}}),Fe=a.entities.add({name:"右侧纹理矩形 (zIndex 3)",show:!1,rectangle:{coordinates:e.Rectangle.fromDegrees(-99.5,20,-90,30),material:x,zIndex:3}}),He=a.entities.add({name:"右侧绿色矩形 (zIndex 2)",show:!1,rectangle:{coordinates:e.Rectangle.fromDegrees(-97.5,25,-88,35),material:e.Color.GREEN,zIndex:2}}),Oe=a.entities.add({name:"右侧蓝色矩形 (zIndex 1)",show:!1,rectangle:{coordinates:e.Rectangle.fromDegrees(-99.5,31,-90,41),material:e.Color.BLUE,zIndex:1}}),Ue=a.entities.add({name:"贴地发光蓝色折线 (zIndex 2)",show:!1,polyline:{positions:e.Cartesian3.fromDegreesArray([-120,22,-80,22]),width:8,material:new e.PolylineGlowMaterialProperty({glowPower:.2,color:e.Color.BLUE}),zIndex:2,clampToGround:!0}});let f=!1,S=!1;const z={equator:O(a,0,{color:e.Color.BLUE}),primeMeridian:H(a,0,{color:e.Color.BLUE}),selectedPoint:{meridian:void 0,parallel:void 0,label:void 0},antipodalPoint:{meridian:void 0,parallel:void 0,label:void 0},lowResolutionGrid:V(a,2,e.Color.PALEGREEN,!1),higherResolutionGrid:V(a,5,e.Color.DARKORANGE,!1)};function Ne(s){const l=z.selectedPoint,d=z.antipodalPoint;e.defined(l.parallel)&&(a.entities.remove(l.parallel),a.entities.remove(l.meridian),a.entities.remove(l.label),a.entities.remove(d.parallel),a.entities.remove(d.meridian),a.entities.remove(d.label));const p=e.Math.toDegrees(s.latitude),B=e.Math.toDegrees(s.longitude),y=.001;l.parallel=O(a,p,{color:e.Color.RED,granularity:y,show:!0}),l.meridian=H(a,B,{color:e.Color.RED,granularity:y,show:!0}),l.label=Y(a,s);const c=Ke(s),G=e.Math.toDegrees(c.latitude),We=e.Math.toDegrees(c.longitude);d.parallel=O(a,G,{color:e.Color.CYAN,granularity:y,show:f}),d.meridian=H(a,We,{color:e.Color.CYAN,granularity:y,show:f}),d.label=Y(a,c),d.label.show=f}T=new e.ScreenSpaceEventHandler(a.scene.canvas),T.setInputAction(function(s){if(!S)return;const l=a.camera.getPickRay(s.position),d=a.scene.globe.pick(l,a.scene);if(!e.defined(d))return;const p=e.Cartographic.fromCartesian(d);Ne(p)},e.ScreenSpaceEventType.LEFT_CLICK);const _=new e.HeadingPitchRange(e.Math.toRadians(30),e.Math.toRadians(-45),3e6);o.show=!0,a.zoomTo(o,_),j({blueBox:o,redBox:P,yellowOutlineOnlyBox:i,greenCircle:r,redEllipse:R,blueEllipse:v,redCorridor:D,greenCorridor:L,blueCorridor:m,greenCylinder:A,redCone:I,saturn:C,saturnInnerRing:E,saturnOuterRing:b,dome:h,domeInner:M,domeTopCut:w,topBottomCut:n,bowl:g,clockCutout:q,partialDome:Q,wedge:X,partialEllipsoid:$,bluePlane:J,redPlane:ee,yellowPlaneOutline:ne,redRectangle:ae,greenRectangle:oe,rotatingRectangle:ie,redPolygon:re,greenPolygon:le,texturedPolygon:te,texturedPolygonWithHoles:se,orangePolygon:de,bluePolygon:me,cyanPolygon:ue,purplePolygonUsingRhumbLines:Ce,redLine:he,greenRhumbLine:ge,glowingLine:ce,orangeOutlined:pe,purpleArrow:we,dashedLine:fe,redDashedLine:ye,blueGapDashedLine:Re,orangeShortDashLine:xe,cyanPatternDashedLine:Pe,yellowPatternDashedLine:ve,redTube:Ie,greenBox:Ee,blueStar:be,redWall:Te,greenWall:Le,blueWall:Me,zIndexRedRect1:ze,zIndexTexturedRect2:Be,zIndexBlueRect3:Ge,zIndexTexturedRect3:Fe,zIndexGreenRect2:He,zIndexBlueRect1:Oe,zIndexPolyline2:Ue,rhumbGridPrimitives:z,onToggleCrosshairClick:s=>{S=s},onToggleAntipodalPoint:s=>{f=s;const l=z.antipodalPoint;e.defined(l.parallel)&&(l.parallel.show=f,l.meridian.show=f,l.label.show=f)}},_)}function j(o,P){t=new je,t.modifyPosition(U.value,{position:"absolute",top:"6px",left:"6px"});const i={blueBox:!0,redBox:!1,yellowOutlineOnlyBox:!1,greenCircle:!1,redEllipse:!1,blueEllipse:!1,redCorridor:!1,greenCorridor:!1,blueCorridor:!1,greenCylinder:!1,redCone:!1,saturn:!1,saturnInnerRing:!1,saturnOuterRing:!1,dome:!1,domeInner:!1,domeTopCut:!1,topBottomCut:!1,bowl:!1,clockCutout:!1,partialDome:!1,wedge:!1,partialEllipsoid:!1,bluePlane:!1,redPlane:!1,yellowPlaneOutline:!1,redRectangle:!1,greenRectangle:!1,rotatingRectangle:!1,redPolygon:!1,greenPolygon:!1,texturedPolygon:!1,texturedPolygonWithHoles:!1,orangePolygon:!1,bluePolygon:!1,cyanPolygon:!1,purplePolygonUsingRhumbLines:!1,redLine:!1,greenRhumbLine:!1,glowingLine:!1,orangeOutlined:!1,purpleArrow:!1,dashedLine:!1,redDashedLine:!1,blueGapDashedLine:!1,orangeShortDashLine:!1,cyanPatternDashedLine:!1,yellowPatternDashedLine:!1,redTube:!1,greenBox:!1,blueStar:!1,redWall:!1,greenWall:!1,blueWall:!1,zIndexAll:!1,zIndexRedRect1:!1,zIndexTexturedRect2:!1,zIndexBlueRect3:!1,zIndexTexturedRect3:!1,zIndexGreenRect2:!1,zIndexBlueRect1:!1,zIndexPolyline2:!1,equator:!1,primeMeridian:!1,lowResolutionGrid:!1,higherResolutionGrid:!1,enableCrosshairClick:!1,showAntipodalPoint:!1},r=(n,g)=>{n.show=g,g&&a.zoomTo(n,P)},R=t.addFolder("立方体 (Box)");R.add(i,"blueBox").name("蓝色盒子").onChange(n=>r(o.blueBox,n)),R.add(i,"redBox").name("黑边红色盒子").onChange(n=>r(o.redBox,n)),R.add(i,"yellowOutlineOnlyBox").name("黄色线框盒子").onChange(n=>r(o.yellowOutlineOnlyBox,n)),R.open();const v=t.addFolder("椭圆 / 圆 (Ellipse)");v.add(i,"greenCircle").name("高空绿色圆").onChange(n=>r(o.greenCircle,n)),v.add(i,"redEllipse").name("地表红色椭圆").onChange(n=>r(o.redEllipse,n)),v.add(i,"blueEllipse").name("蓝色柱体椭圆").onChange(n=>r(o.blueEllipse,n));const D=t.addFolder("走廊 (Corridor)");D.add(i,"redCorridor").name("地表圆角红色走廊").onChange(n=>r(o.redCorridor,n)),D.add(i,"greenCorridor").name("高空尖角绿色走廊").onChange(n=>r(o.greenCorridor,n)),D.add(i,"blueCorridor").name("白边斜角蓝色走廊").onChange(n=>r(o.blueCorridor,n));const L=t.addFolder("圆柱 / 圆锥 (Cylinder)");L.add(i,"greenCylinder").name("绿色圆柱体").onChange(n=>r(o.greenCylinder,n)),L.add(i,"redCone").name("红色圆锥体").onChange(n=>r(o.redCone,n));const m=t.addFolder("椭球体 / 局部椭球 (Ellipsoid)");m.add(i,"saturn").name("土星本体").onChange(n=>r(o.saturn,n)),m.add(i,"saturnInnerRing").name("土星内环").onChange(n=>r(o.saturnInnerRing,n)),m.add(i,"saturnOuterRing").name("土星外环").onChange(n=>r(o.saturnOuterRing,n)),m.add(i,"dome").name("圆顶球壳").onChange(n=>r(o.dome,n)),m.add(i,"domeInner").name("带内半径的圆顶").onChange(n=>r(o.domeInner,n)),m.add(i,"domeTopCut").name("顶部裁剪圆顶").onChange(n=>r(o.domeTopCut,n)),m.add(i,"topBottomCut").name("上下裁剪球壳").onChange(n=>r(o.topBottomCut,n)),m.add(i,"bowl").name("碗状结构").onChange(n=>r(o.bowl,n)),m.add(i,"clockCutout").name("时钟角度裁剪").onChange(n=>r(o.clockCutout,n)),m.add(i,"partialDome").name("局部半球圆顶").onChange(n=>r(o.partialDome,n)),m.add(i,"wedge").name("契形结构").onChange(n=>r(o.wedge,n)),m.add(i,"partialEllipsoid").name("局部椭球体").onChange(n=>r(o.partialEllipsoid,n));const A=t.addFolder("平面 (Plane)");A.add(i,"bluePlane").name("蓝色平面").onChange(n=>r(o.bluePlane,n)),A.add(i,"redPlane").name("黑边红色平面").onChange(n=>r(o.redPlane,n)),A.add(i,"yellowPlaneOutline").name("黄色线框平面").onChange(n=>r(o.yellowPlaneOutline,n));const I=t.addFolder("矩形 (Rectangle)");I.add(i,"redRectangle").name("红色半透明矩形").onChange(n=>r(o.redRectangle,n)),I.add(i,"greenRectangle").name("高空旋转拉伸绿色矩形").onChange(n=>r(o.greenRectangle,n)),I.add(i,"rotatingRectangle").name("动态旋转纹理矩形").onChange(n=>r(o.rotatingRectangle,n));const u=t.addFolder("多边形 (Polygon)");u.add(i,"redPolygon").name("地表红色多边形").onChange(n=>r(o.redPolygon,n)),u.add(i,"greenPolygon").name("绿色拉伸多边形").onChange(n=>r(o.greenPolygon,n)),u.add(i,"texturedPolygon").name("纹理拉伸多边形").onChange(n=>r(o.texturedPolygon,n)),u.add(i,"texturedPolygonWithHoles").name("带孔纹理多边形").onChange(n=>r(o.texturedPolygonWithHoles,n)),u.add(i,"orangePolygon").name("带点高度橙色多边形").onChange(n=>r(o.orangePolygon,n)),u.add(i,"bluePolygon").name("带多孔嵌套蓝色多边形").onChange(n=>r(o.bluePolygon,n)),u.add(i,"cyanPolygon").name("青色垂直多边形").onChange(n=>r(o.cyanPolygon,n)),u.add(i,"purplePolygonUsingRhumbLines").name("等角航线紫色多边形").onChange(n=>r(o.purplePolygonUsingRhumbLines,n));const C=t.addFolder("折线 (Polyline)");C.add(i,"redLine").name("贴地红色折线").onChange(n=>r(o.redLine,n)),C.add(i,"greenRhumbLine").name("绿色等角航线").onChange(n=>r(o.greenRhumbLine,n)),C.add(i,"glowingLine").name("地表发光蓝色折线").onChange(n=>r(o.glowingLine,n)),C.add(i,"orangeOutlined").name("高空黑边橙色折线").onChange(n=>r(o.orangeOutlined,n)),C.add(i,"purpleArrow").name("高空紫光箭头折线").onChange(n=>r(o.purpleArrow,n)),C.add(i,"dashedLine").name("高空虚线折线").onChange(n=>r(o.dashedLine,n)),C.add(i,"redDashedLine").name("红色高空虚线").onChange(n=>r(o.redDashedLine,n)),C.add(i,"blueGapDashedLine").name("双色带间隙蓝黄虚线").onChange(n=>r(o.blueGapDashedLine,n)),C.add(i,"orangeShortDashLine").name("短段节橙色虚线").onChange(n=>r(o.orangeShortDashLine,n)),C.add(i,"cyanPatternDashedLine").name("自定模式青色虚线").onChange(n=>r(o.cyanPatternDashedLine,n)),C.add(i,"yellowPatternDashedLine").name("自定点划模式黄色虚线").onChange(n=>r(o.yellowPatternDashedLine,n));const E=t.addFolder("管道体积体 (PolylineVolume)");E.add(i,"redTube").name("红色管道圆角柱体").onChange(n=>r(o.redTube,n)),E.add(i,"greenBox").name("绿色方形斜角柱体").onChange(n=>r(o.greenBox,n)),E.add(i,"blueStar").name("蓝色星形尖角柱体").onChange(n=>r(o.blueStar,n));const b=t.addFolder("墙体 (Wall)");b.add(i,"redWall").name("高空红色墙体").onChange(n=>r(o.redWall,n)),b.add(i,"greenWall").name("带边框绿色墙体").onChange(n=>r(o.greenWall,n)),b.add(i,"blueWall").name("锯齿起伏蓝色墙体").onChange(n=>r(o.blueWall,n));const h=t.addFolder("贴地层级 (Z-Index)"),M=[o.zIndexRedRect1,o.zIndexTexturedRect2,o.zIndexBlueRect3,o.zIndexTexturedRect3,o.zIndexGreenRect2,o.zIndexBlueRect1,o.zIndexPolyline2];h.add(i,"zIndexAll").name("一键展示全部 Z-Index 示例").onChange(n=>{M.forEach(g=>g.show=n),i.zIndexRedRect1=n,i.zIndexTexturedRect2=n,i.zIndexBlueRect3=n,i.zIndexTexturedRect3=n,i.zIndexGreenRect2=n,i.zIndexBlueRect1=n,i.zIndexPolyline2=n,t.updateDisplay(),n&&a.zoomTo(M,P)}),h.add(i,"zIndexRedRect1").name("红色矩形 (zIndex 1)").onChange(n=>r(o.zIndexRedRect1,n)),h.add(i,"zIndexTexturedRect2").name("纹理矩形 (zIndex 2)").onChange(n=>r(o.zIndexTexturedRect2,n)),h.add(i,"zIndexBlueRect3").name("蓝色矩形 (zIndex 3)").onChange(n=>r(o.zIndexBlueRect3,n)),h.add(i,"zIndexTexturedRect3").name("右侧纹理矩形 (zIndex 3)").onChange(n=>r(o.zIndexTexturedRect3,n)),h.add(i,"zIndexGreenRect2").name("右侧绿色矩形 (zIndex 2)").onChange(n=>r(o.zIndexGreenRect2,n)),h.add(i,"zIndexBlueRect1").name("右侧蓝色矩形 (zIndex 1)").onChange(n=>r(o.zIndexBlueRect1,n)),h.add(i,"zIndexPolyline2").name("贴地发光蓝色折线 (zIndex 2)").onChange(n=>r(o.zIndexPolyline2,n));const w=t.addFolder("等角航线与经纬网 (Rhumb Lines & Grid)");w.add(i,"equator").name("赤道 (Equator)").onChange(n=>{o.rhumbGridPrimitives&&(o.rhumbGridPrimitives.equator.show=n)}),w.add(i,"primeMeridian").name("本初子午线 (Prime Meridian)").onChange(n=>{o.rhumbGridPrimitives&&(o.rhumbGridPrimitives.primeMeridian.show=n)}),w.add(i,"lowResolutionGrid").name("低分辨率经纬网 (Low Res)").onChange(n=>{o.rhumbGridPrimitives&&o.rhumbGridPrimitives.lowResolutionGrid.forEach(g=>g.show=n)}),w.add(i,"higherResolutionGrid").name("高分辨率经纬网 (High Res)").onChange(n=>{o.rhumbGridPrimitives&&o.rhumbGridPrimitives.higherResolutionGrid.forEach(g=>g.show=n)}),w.add(i,"enableCrosshairClick").name("开启点击生成十字线").onChange(n=>{o.onToggleCrosshairClick&&o.onToggleCrosshairClick(n)}),w.add(i,"showAntipodalPoint").name("显示点选对跖点 (Antipodal)").onChange(n=>{o.onToggleAntipodalPoint&&o.onToggleAntipodalPoint(n)})}return Je(()=>{F&&clearTimeout(F),T&&T.destroy(),t&&t.destroy(),a&&a.destroy()}),(o,P)=>(en(),nn(Ye,{codeBlocks:rn(K)},{default:an(()=>[on("div",sn,null,512)]),_:1},8,["codeBlocks"]))}}),wn=qe(mn,[["__scopeId","data-v-75ab0fda"]]);export{wn as default};
